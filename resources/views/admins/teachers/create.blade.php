...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mt-5">
        <h1 style="font-weight: bold" class="h3 mb-4 text-gray-800" style="margin-left:30px ">Add New Teacher</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    @enderror
                    @if ($teacher->image)
                    <img style="width: 80px" src="{{ asset('uploads/post/'.$teacher->image) }}">
                    @endif
                </div>
            </div>
            <div class="col-md-6">
            ...
            <button class="btn btn-success w-25 mx-auto" style="font-weight: bold"><i class="fas fa-save"></i> Add</button>
    </form>
