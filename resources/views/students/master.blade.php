                ...
                <div class="header3-wrap">
                    ...
                    <div class="header__navbar">
                        <ul class="list-unstyled">
                            <li {{ request()->routeIs('students.home') ? 'class=active' : '' }}>
                                <a href="{{ route('students.home') }}" >
                                    <i class="fas fa-tachometer-alt"></i>Dashboard
                                    <span class="bot-line"></span>
                                </a>
                            </li>
                            <li {{ request()->routeIs('students.courses') ? 'class=active' : '' }}>
                                <a href="{{ route('students.courses') }}">
                                    <i class="fas fa-laptop"></i>
                                    <span class="bot-line"></span>My Courses</a>
                            </li>
                            <li {{ request()->routeIs('students.appointment') ? 'class=active' : '' }}>
                                <a href="{{ route('students.appointments') }}">
